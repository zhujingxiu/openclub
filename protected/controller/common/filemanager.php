...
class ControllerCommonFilemanager extends Controller {
	...
	public function create() {
		...
		if (!$this->user->hasPermission('modify', 'common/filemanager/create')) {
	...
	public function delete() {
		...
		if (!$this->user->hasPermission('modify', 'common/filemanager/delete')) {
      		$json['error'] = $this->language->get('error_permission');  
    	}
	...
	public function move() {
		...
		if (!$this->user->hasPermission('modify', 'common/filemanager/move')) {
      		$json['error'] = $this->language->get('error_permission');  
    	}
	...
	public function copy() {
		...
		if (!$this->user->hasPermission('modify', 'common/filemanager/copy')) {
      		$json['error'] = $this->language->get('error_permission');  
    	}	
	...
	public function rename() {
		...
		if (!$this->user->hasPermission('modify', 'common/filemanager/rename')) {
      		$json['error'] = $this->language->get('error_permission');  
    	}
	...
	public function upload() {
		...
		if (!$this->user->hasPermission('modify', 'common/filemanager/upload')) {
      		$json['error'] = $this->language->get('error_permission');  
    	}
