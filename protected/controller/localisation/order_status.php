...
class ControllerLocalisationOrderStatus extends Controller { 
	private $error = array();
  	...
  	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm('localisation/order_status/insert')) {
  	...
  	public function update() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm('localisation/order_status/update')) {
  	...
  	public function delete() {
    	...
    	if (isset($this->request->post['selected']) && $this->validateDelete('localisation/order_status/delete')) {
  	...
  	protected function getList() {
    	...
    	foreach ($results as $result) {
			...
			$this->data['order_statuses'][] = array(
				...
				'specified'	  => $result['specified'] ? $this->language->get('text_yes') : $this->language->get('text_no'),
  	...
  	protected function getForm() {
		...
		if (isset($this->request->post['order_status'])) {
  		...
  		if (isset($this->request->post['order_status_specified'])) {
			$this->data['order_status_specified'] = $this->request->post['order_status_specified'];
		} elseif (isset($this->request->get['order_status_id'])) {
			$order_status = $this->model_localisation_order_status->getOrderStatus($this->request->get['order_status_id']);
			$this->data['order_status_specified'] = $order_status['specified'];
		} else {
			$this->data['order_status_specified'] = 0;
		}
