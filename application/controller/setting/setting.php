...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_faq_status'])) {
			$this->data['config_faq_status'] = $this->request->post['config_faq_status'];
		} else {
			$this->data['config_faq_status'] = $this->config->get('config_faq_status');
		}
		...
		if (isset($this->request->post['config_project_status_id'])) {
			$this->data['config_project_status_id'] = $this->request->post['config_project_status_id'];
		} else {
			$this->data['config_project_status_id'] = $this->config->get('config_project_status_id');		
		}
		...
		if (isset($this->request->post['config_complete_project_status_id'])) {
			$this->data['config_complete_project_status_id'] = $this->request->post['config_complete_project_status_id'];
		} else {
			$this->data['config_complete_project_status_id'] = $this->config->get('config_complete_project_status_id');
		}
		...
		$this->data['project_statuses'] = $this->model_localisation_project_status->getProjectSpecifiedStatuses();
		...
		if (isset($this->request->post['config_testing_email'])) {
			$this->data['config_testing_email'] = $this->request->post['config_testing_email'];
		} else {
			$this->data['config_testing_email'] = $this->config->get('config_testing_email');
		}		
